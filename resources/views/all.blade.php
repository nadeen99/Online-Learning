...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{ __('All Courses') }}</div>
             ...
             <div class="courses">
                 <div class="box">
                      <div class="text">
                        <h3>{{$c->name}}</h3>
                        <p>{{$c->description}}</p>
                        <p>Course Duration: {{$c->duration}}</p>
                        @if($c->price == "free")
                      <p style="font-weight:bold;">Free</p>
                        @else
                        <p style="font-weight:bold;">Priced</p>
                        @endif
                      </div>      

                      <div class="info">
                      @if($c->price == "free")
                      <a href="{{route('store',$c->id)}}">Get Course</a>
                        @else
                        <a href="/toplanspage">Course details</a>
